# Multi-Organ Surveillance Protocol
...
### Thyroid (Post-Total Thyroidectomy)
...
| Modality | Interval | Notes |
|----------|----------|-------|
| **Breast MRI and/or mammography** | Annual | Bilateral proliferative changes: fibroadenomatous change, PASH, columnar cell change, cystic/papillary apocrine metaplasia. Field effect pattern warrants monitoring |
...
- Reproductive genetic counseling with PGT-M option

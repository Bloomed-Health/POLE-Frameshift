...
| Finding | Details | Significance |
|---------|---------|-------------|
| **Stage IV+ deep infiltrating endometriosis** | Extension into thoracic diaphragm | Extraordinarily severe; diaphragmatic extension represents the most advanced form, is rare, and indicates an extremely aggressive endometrial tissue phenotype |
